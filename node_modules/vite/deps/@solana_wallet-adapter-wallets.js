...
} from "/node_modules/.vite/deps/chunk-LEWQCWUO.js?v=e3f16828";
import {
  SOLANA_DEVNET_CHAIN,
  ...
  createSignInMessage,
  registerWallet
} from "/node_modules/.vite/deps/chunk-7ADWSKN3.js?v=e3f16828";
import {
...
} from "/node_modules/.vite/deps/chunk-ICS5TY5L.js?v=e3f16828";
import {
  SolanaSignAndSendTransaction,
  SolanaSignMessage,
  SolanaSignTransaction
} from "/node_modules/.vite/deps/chunk-SNZVU36D.js?v=e3f16828";
import "/node_modules/.vite/deps/chunk-XAZ6AATU.js?v=e3f16828";
import "/node_modules/.vite/deps/chunk-NHIXJROC.js?v=e3f16828";
import {
  Keypair,
  PublicKey,
  ed25519,
  ...
  require_buffer,
  require_safe_buffer
} from "/node_modules/.vite/deps/chunk-FZHJW7PJ.js?v=e3f16828";
import {
  __commonJS,
  __toESM
} from "/node_modules/.vite/deps/chunk-MVEJMUOB.js?v=e3f16828";
...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        FractalWalletClass = (await import("/node_modules/.vite/deps/esm-ZQV4ACYU.js?v=e3f16828")).FractalWalletAdapterImpl;
      } catch (error) {
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let keyring;
      try {
        const { DefaultKeyring } = await import("/node_modules/.vite/deps/dist-HXAHMADH.js?v=e3f16828");
...
var LedgerWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        TransportWebHIDClass = (await import("/node_modules/.vite/deps/TransportWebHID-ANXHVDRQ.js?v=e3f16828")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let transport;
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WalletClass;
      try {
        ({ ParticleNetwork: ParticleClass, SolanaWallet: WalletClass } = await import("/node_modules/.vite/deps/es-4KTF5ZVI.js?v=e3f16828"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let particle;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SalmonClass;
      try {
        SalmonClass = (await import("/node_modules/.vite/deps/esm-FFWJ4PIE.js?v=e3f16828")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
  ...
  constructor() {
    ...
    _SolflareMetaMaskWallet_connect.set(this, async () => {
      if (!__classPrivateFieldGet(this, _SolflareMetaMaskWallet_solflareMetaMask, "f")) {
        ...
        try {
          SolflareMetaMaskClass = (await import("/node_modules/.vite/deps/esm-POEY6U4L.js?v=e3f16828")).default;
        } catch (error) {
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("/node_modules/.vite/deps/esm-XMQIWULH.js?v=e3f16828")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let TorusClass;
      try {
        TorusClass = (await import("/node_modules/.vite/deps/solanaEmbed.esm-I2K3AESP.js?v=17533643")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TrezorWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    ...
    try {
      ...
      let wallet;
      try {
        const { default: TrezorConnect } = await import("/node_modules/.vite/deps/lib-5HT2QIWC.js?v=e3f16828");
...
var WalletConnectWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WCChainID;
      try {
        ({ WalletConnectWallet: WalletConnectClass, WalletConnectChainID: WCChainID } = await import("/node_modules/.vite/deps/esm-H555H6JY.js?v=e3f16828"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
